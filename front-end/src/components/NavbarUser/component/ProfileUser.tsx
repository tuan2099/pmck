...
function ProfileUser() {
  ...
  return (
    <>
      <Menu >
        <MenuHandler className="mx-2 cursor-pointer">
          <Avatar
            variant="circular"
            alt="tania andrew"
        ...
        <MenuList className='text-color1 w-[20%]'>
          ...
          <MenuItem className="flex items-center gap-2 " onClick={handleLogout} key={uuidv4()}>
            <svg
              width="16"
              height="14"
              viewBox="0 0 16 14"
