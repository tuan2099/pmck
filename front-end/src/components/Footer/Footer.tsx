...
function Footer() {
  return (
    <footer className='relative bg-[#434f6a]'>
      <div className='custom-shape-divider-top-1684486279'>
      ...
      <div className='mx-auto w-full max-w-screen-xl'>
        <div className='grid grid-cols-2 gap-8 px-4 py-6 md:grid-cols-4 lg:py-8'>
          <div>
            <h2 className='mb-6 text-sm font-semibold uppercase text-white dark:text-white'>Giới thiệu</h2>
            <ul className='font-medium text-gray-500 dark:text-gray-400'></ul>
          </div>
          <div>
            <h2 className='mb-6 text-sm font-semibold uppercase text-white dark:text-white'>Help center</h2>
          ...
          <div>
            <h2 className='mb-6 text-sm font-semibold uppercase text-white dark:text-white'>Download</h2>
            <ul className='font-medium text-gray-500 dark:text-gray-400'>
              <li className='mb-4'>
                <Link to='#' className='hover:underline'>
                  iOS
        ...
        <div className=' bg-gray-100 px-4 py-6 dark:bg-gray-700 md:flex md:items-center md:justify-between'>
          <span className='text-sm text-gray-500 dark:text-gray-300 sm:text-center'>
            © 2023 <a href='https://flowbite.com/'>PMC™</a>. All Rights Reserved.
          </span>
