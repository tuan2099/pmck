...
function Event() {
  return (
    <>
      <section className='m-auto mb-10 max-w-[1320px]'>
        <div className='my-[50px] px-[10px] text-center'>
          <p className='text-[20px] font-semibold italic leading-[150%] text-mainGreenColor'>New Courses</p>
          <h2 className='pb-[24px] pt-[15px] text-[20px] font-bold leading-[120%] text-[#4F4F4F] lg:text-[32px]'>
            Featured Instructor
          </h2>
        </div>
        <div className='flex flex-wrap items-center justify-between'>
          <div className='w-full px-[12px] md:w-1/2 lg:w-4/12'>
