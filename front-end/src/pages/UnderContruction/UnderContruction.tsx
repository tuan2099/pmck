    ...
    <>
      <div className='flex h-screen items-center justify-between bg-[url(http://localhost:1337/uploads/error_bg1_bc6c15a9a1.png)] bg-cover bg-no-repeat'>
        <div className='m-auto max-w-[570px] px-2'>
          ...
          <div className='mt-12'>
            <h1 className='text-center text-4xl font-bold uppercase text-mainGreenColor'>Under Contruction</h1>
            <p className='my-4 text-center font-semibold text-color1'>Trang này hiện đang trong quá trình phát triển</p>
